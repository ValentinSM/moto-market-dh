  ...
  <div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">
        Categorias</a> <a href="#" class="current">Ver Categorias</a> </div>
      <h1>Categorias</h1>
                  ...
                  @foreach ($categories as $category)
                    <tr class="gradeX">
                      ...
                      <td class="center">
                        ...
                        <a href="javascript:" rel="{{ $category->id }}" rel1="delete-category" class="btn btn-danger btn-mini deleteRecord">Borrar</a></td>
                      </tr>
