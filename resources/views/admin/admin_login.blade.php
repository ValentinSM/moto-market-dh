    ...
    <body>
        ...
        @endif
            ...
            <form id="loginform" class="form-vertical" method="post" action="{{ url('admin') }}">
              {{ csrf_field() }}
				 <div class="control-group normal_text"> <h3><img src="{{ asset('images/frontend_images/logo.png') }}" alt="Logo" /></h3></div>
                ...
                <div class="form-actions">
                    <span class="pull-left"><a href="#" class="flip-link btn btn-info" id="to-recover">No recuerdas la contraseña?</a></span>
